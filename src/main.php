...
use sancho2804\rest_client\main as rest_client;
...
class main{
	...
	private function init_rest($token){
		$this->rest=new rest_client('https://cloud-api.yandex.net:443/v1/','OAuth',$token);
		$this->rest->set_service('yandex_disk');
	}
